four51.app.factory('CustomErrors', function() {
    ...
    var _hdkMessage = "Please create a separate order for Healthy Kids Day Items. Orders with HKD items received by 3/8/19 will ship week of 4/8/19.";
    ...
    var _normalHDKMessage = "Please create a separate order for stocked items. Healthy Kids Day items need to be on their own order.";

    return {
        cppMessage:  _cppMessage,
        hdkMessage:  _hdkMessage,
        normalCPPMessage:  _normalCPPMessage,
        normalHDKMessage:  _normalHDKMessage
    };
});
